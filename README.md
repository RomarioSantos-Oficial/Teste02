...
1. Copie `SectorFlow_Setup_0.0.2.exe` para o computador.
...
```bat
SectorFlow_Setup_0.0.2.exe
```

Instalação silenciosa:

```bat
SectorFlow_Setup_0.0.2.exe /VERYSILENT /SUPPRESSMSGBOXES /NORESTART /CLOSEAPPLICATIONS
```

Instalação silenciosa com log:

```bat
SectorFlow_Setup_0.0.2.exe /VERYSILENT /SUPPRESSMSGBOXES /NORESTART /CLOSEAPPLICATIONS /LOG="%TEMP%\SectorFlow-install.log"
```
...
```bat
powershell -NoProfile -Command "Get-FileHash '.\SectorFlow_Setup_0.0.2.exe' -Algorithm SHA256"
```

SHA-256 do instalador 0.0.2 gerado em 10/08/2026:

```text
1B13940DC6C7F330C505CEAD331A3E7285254AAC8433169CB4109982438ED92B
```
