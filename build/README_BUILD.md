...
Isso gera:
- `app\SectorFlow_Setup_0.0.7.exe` — instalador profissional
...
Distribua o arquivo `app\SectorFlow_Setup_0.0.7.exe`. O usuário executa e o instalador cuida de tudo.
...
│
├── SectorFlow_Setup_0.0.7.exe     ← Instalador (se usar Inno Setup)
└── SectorFlow ALFA 0.0.7.zip      ← Pacote ZIP
```
