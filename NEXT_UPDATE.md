...
- [ ] Preservar o idioma escolhido no aplicativo durante uma atualização. O instalador deve criar `%LOCALAPPDATA%\SectorFlow\language.json` somente quando o arquivo ainda não existir, sem substituir a preferência atual do usuário.
